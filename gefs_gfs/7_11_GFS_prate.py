...
for step in forecast_steps:
    ...
    try:
        ...
        fig.suptitle(f"plot4 estimated precip/prate & mslp — Run: {run_date} {run_hour}Z | Forecast: {step_str} ({forecast_local_time} EST, {forecast_day}){accuracy_str}", fontsize=8, fontweight='bold', y=0.80)
